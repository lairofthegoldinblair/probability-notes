...
\begin{defn}Let $(\Omega, \mathcal{A})$ be a measurable space the we let $\Osc_{\Omega}$ be the set of all measurable functions $f : \Omega \to \reals$ such that $\sup_{x,  y  \in \Omega} \abs{f(x) - f(y)} \leq 1$.
\end{defn}
...
\begin{align*}
\tvnorm{\nu} &= \nu(A_+) = \sup_{A \in \mathcal{A}} \abs{\nu(A)} = \sup_{f \in \Osc_{\Omega}} \abs{\int f \, d\nu}
\end{align*}
\end{prop}
\begin{proof}
...
To see the last equality we first assume that $f \in \Osc_{\Omega}$ and calculate
\begin{align*}
\abs{\int f \, d\nu} &= \abs{\int f(x) \, d\nu_+(x) - \int f(y) \, d\nu_-(y)} \\
&= \abs{\frac{1}{\nu_-(\Omega)} \iint f(x) \, d\nu_+(x) d\nu_-(y) - \frac{1}{\nu_-(\Omega)}\iint f(y) \, d \nu_+(x) d\nu_+(y)} \\
&\leq \frac{1}{\tvnorm{\nu}} \iint \abs{ f(x) - f(y) } \, d\nu_+(x) d\nu_-(y)  \leq \tvnorm{\nu} \\
\end{align*}
To see the opposite inequality simply observe that $\characteristic{A_+} \in \Osc_{\Omega}$ so it follows that $\tvnorm{\nu}  = \nu(A_+) \leq \sup_{f \in \Osc_{\Omega}} \abs{\int f \, d\nu}$.
\end{proof}
...
&= \sup_{g \in \Osc_{T}} \left \lbrace \osc \left( \int g(y) \, \mu(x, dy) \right) \right \rbrace \\
...
\begin{align*}
\beta(\mu) &= \sup_{x,y \in S} \tvnorm{\mu(x, \cdot) - \mu(y, \cdot)} \\
&= \sup_{x,y \in S}\sup_{g \in \Osc_{T}} \abs{\int g(z) \, \mu(x, dz)  - \int g(z) \, \mu(y, dz)} \\
&= \sup_{g \in \Osc_{T}} \sup_{x,y \in S} \abs{\int g(z) \, \mu(x, dz)  - \int g(z) \, \mu(y, dz)} \\
&= \sup_{g \in \Osc_{T}} \osc{\int g(z) \, \mu(x, dz)} \\
\end{align*}
