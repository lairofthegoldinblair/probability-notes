...
$\lim_{n \to \infty} \probability{\sup_{m \geq n} d(\xi_m, \xi_n) > \epsilon}
= 0$.  
\end{lem}
\begin{proof}
...
Our first goal is to establish that convergence in
...
\begin{lem}Let $\xi_n$ be a sequence of real valued random variables
