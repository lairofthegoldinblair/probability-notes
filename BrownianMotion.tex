...
monotone classes (e.g. Lemma \ref{IndependenceFinitary}).  Up till this point we have been treating
...
\begin{defn}\label{defn:GaussianProcess}A process $X_t$ on a time scale $T$ is called a
