...
\hypersetup{bookmarks=true,%
    ...
    pdfauthor={David Blair},
    pdfsubject={},
    pdfkeywords={},
    %pagebackref,%
    colorlinks=true,%
    frenchlinks=false,% set links in small-caps font instead of color.
    linkcolor=blue,%
    urlcolor=blue,%
    citecolor=blue,% citation reference color
    filecolor=blue,%
    pdfpagemode=None,% don't show thumbs/bookmarks
    pdfstartview=FitH,% window fits Horizontal (width) page dimension
    hyperindex=true%
}

\DeclareMathOperator*{\argmin}{arg\,min}
\DeclareMathOperator*{\argmax}{arg\,max}
\DeclareMathOperator*{\cardfun}{card}
...
\DeclareMathOperator*{\convexhullop}{conv}
\DeclareMathOperator*{\symmconvexhullop}{sconv}
\DeclareMathOperator*{\Lip}{Lip}
\DeclareMathOperator*{\loc}{loc}
\DeclareMathOperator*{\Osc1}{Osc_{1}}
\DeclareMathOperator*{\osc}{osc}
\DeclareMathOperator*{\poisop}{Pois}
\DeclareMathOperator*{\spectralradiusop}{spr}
...
\newcommand{\sexpectation}[2]{\textbf{E}_{#2}\left [#1 \right]} 
...
\newcommand{\oexpectation}[1]{\textbf{E}^*\left[#1\right]} 
\newcommand{\oexpectationop}{\textbf{E}^*}
\newcommand{\soexpectation}[2]{\textbf{E}^*_{#2}\left [#1 \right]} 
\newcommand{\iexpectation}[1]{\textbf{E}_*\left[#1\right]} 
\newcommand{\iexpectationop}{\textbf{E}_*}
...
\newcommand{\sprobability}[2]{\textbf{P}_{#2} \left \{#1 \right \}}
\newcommand{\sprobabilityop}[1]{\textbf{P}_{#1}}
\newcommand{\cprobability}[2]{\textbf{P} \left \{#2 \mid #1 \right \}} 
\newcommand{\csprobability}[3]{\textbf{P}_{#3} \left \{#2 \mid #1 \right \}} 
\newcommand{\oprobability}[1]{\textbf{P}^* \left \{#1 \right \}} 
\newcommand{\soprobability}[2]{\textbf{P}^*_{#2} \left \{#1 \right \}}
\newcommand{\iprobability}[1]{\textbf{P}_* \left \{#1 \right \}} 
\newcommand{\siprobability}[2]{(\textbf{P}_{#2})_* \left \{#1 \right \}}
...
\include{GaussianProcesses}

\include{EmpiricalProcesses}

\include{GeneralTheoryOfProcesses}

\include{MeanFieldModels}
