...
TODO: Update the following statement and proof to use arbitrary familiies of processes (and replace the $\limsup_{n \to \infty}$ with $\sup_{\alpha \in A}$)
